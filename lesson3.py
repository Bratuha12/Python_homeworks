...
my_str = "Who Let The Dogs Out"
for symbol_ in my_str[::2]:
    print(symbol_, end="")
print()
#####################################################
# 5) У вас есть переменная my_str, тип - str.
# Напечатать все символы, стоящие на четных местах (начиная с нуля).
# Может имелось в виду на нечетных местах?
my_str = "Who Let The Dogs Out"
for symbol_ in my_str[1::2]:
    print(symbol_, end="")
print()
#####################################################
# 6) У вас есть переменная my_str, тип - str.
# Если ее длинна меньше 5, то допишите в конец строки себя же.
# Пример: было - "qwer", стало - "qwerqwer". Если длинна не меньше 5,
# то оставить строку как есть.
my_str = "asdf"
...
# Пример: было - "qwer", стало - "qwerrewq". Если длинна не меньше 5,
# то оставить строку как есть.
my_str = "asdf"
